...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     osx
     better-defaults
     ;; required to use local eslint in typescript layerx
     (javascript :variables
                 ;; this is necessary so that the typescript layer can use
                 ;; local eslint installatin with plugins
...
before packages are loaded."
  ...
  (global-set-key (kbd "H-j") 'shrink-window-horizontally)
